...
| plugins         | 1.22 KB | `ts-time-utils/plugins`         |
...
| chain           | 2.15 KB | `ts-time-utils/chain`           |
...
| timezone        | 2.86 KB | `ts-time-utils/timezone`        |
...
| naturalLanguage | 2.94 KB | `ts-time-utils/naturalLanguage` |
