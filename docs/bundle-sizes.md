...
**Smallest footprint** (~1 KB): `constants`, `rangePresets`, `age`, `interval`

**Medium** (1-3 KB): Most modules including `format`, `calculate`, `validate`, `calendar`, `timezone`

**Larger** (3+ KB): `locale` (7.26 KB) - contains 40+ locale configurations
